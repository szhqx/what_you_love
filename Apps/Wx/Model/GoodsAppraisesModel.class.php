...
class GoodsAppraisesModel extends BaseModel {
	 ...
	 * 获取指定商品评价
	 */
	public function getGoodsAppraise($goodId){
		$m = M('goods_appraises');
		$id = $goodId;
		$sql = "select gp.*,u.nickName,u.userName from __PREFIX__goods_appraises gp ,__PREFIX__users u where gp.userId=u.userId and gp.goodsId=".$id;
