...
class GoodsModel extends BaseModel {
					...
					if(!empty($attrRs)){
						...
						if($priceAttrId>0){
							...
							for ($i=0;$i<=$no;$i++){
								...
								$attr['attrlowPrice'] = (float)I('price_lowprice_'.$priceAttrId."_".$i);
	 ...
	 */
	 public function get(){
		...
		//获取规格属性
		$sql = "select ga.attrVal,ga.attrPrice,ga.attrlowPrice,ga.attrStock,ga.isRecomm,a.attrId,a.attrName,a.isPriceAttr,a.attrType,a.attrContent
