...
<html lang="zh-cn">
   ...
   function changeStatus(id,v){
	   ...
	   $.post("<?php echo U('Admin/Goods/changePenddingGoodsStatus');?>",$("#myform").serialize(),function(data,textStatus){
				...
				if(json.status=='1'){
					...
					Plugins.closeWindow();
					Plugins.Tips({title:'信息提示',icon:'error',content:'操作失败，可能存在利率没填!',timeout:3000});
   ...
   <body class="wst-page">
       <form name="myform" method="post" id="myform">
		   <input name="id" value="<?php echo ($object['goodsId']); ?>" type="hidden">
    	...
    	<div class='wst-tab-item'>
	        ...
	        <table class="table table-hover table-striped table-bordered wst-form">
	           ...
	           <tr>
				...
				<tr>
					<th width='120'>店铺低级<font color='red'>*</font>：</th>
					<td><?php echo ($object["lowPrice"]); ?></td>
				</tr>
	            <tr>
	           ...
	           <tr>
				...
				<tr>
					<th width='120'>利润<font color='red'>*</font>：</th>
					<td colspan='3'>
						<input name="profitPrice" value="<?php echo ($object['profitPrice']); ?>">【用于分销中计算金额,至少大于0】
					</td>
				</tr>
	           <tr>
						...
						<td style='margin:0px;'>
							<?php if( count($object.priceAttrs) > 0): ?><table class="table wst-list" style='margin:0px;border-top:1px solid #ddd;'>
									...
									<tr>
										...
										<th style='background:#f5f5f5'>利润</th>
									</tr>
									</thead>
									<?php if(is_array($object["priceAttrs"])): $i = 0; $__LIST__ = $object["priceAttrs"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style='margin:0px;'>
											...
											<td><?php echo ($vo['attrlowPrice']); ?></td>
											<td><input name="profitPrice_<?php echo ($vo["attributesId"]); ?>" value="<?php echo ($vo['profitPrice']); ?>">【用于分销中计算金额,至少大于0】</td>
