        ...
        <table class="table table-hover table-striped table-bordered wst-list">
           ...
           <tbody>
            <?php if(is_array($Page['root'])): $i = 0; $__LIST__ = $Page['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               ...
               <td>
               <a class="btn btn-primary glyphicon" href='<?php echo U("Admin/Goods/toPenddingView",array("id"=>$vo["goodsId"]));?>'>审核</a>
               <!--<?php if(in_array('spsh_04',$WST_STAFF['grant'])){ ?>-->
               <!--<?php if($vo['goodsStatus']==1 ): ?>-->
               <!--<button type="button" class="btn btn-danger glyphicon glyphicon-pencil" onclick="javascript:changeStatus(<?php echo ($vo['goodsId']); ?>,0)">不通过</button>&nbsp;-->
               <!--<?php else: ?>-->
               <!--<button type="button" class="btn btn-success glyphicon glyphicon-pencil" onclick="javascript:changeStatus(<?php echo ($vo['goodsId']); ?>,1)">通过</button>&nbsp;-->
               <!--<?php endif; ?>-->
               <!--<?php } ?>-->
               </td>
