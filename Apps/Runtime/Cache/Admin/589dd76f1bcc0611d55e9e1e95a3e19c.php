...
//	   }
   ...
   <body class="wst-page" style="position:relative;">
       ...
       <form name="myform" method="post" id="myform" autocomplete="off" action="<?php echo U('Shops/edit');?>">
           ...
           <tr style="height:80px;">
             ...
             <td>
	             <div id="preview_Filedata" style="margin-top: 70px;">
	             	<img id='preview' src='/<?php echo ($object["shopImg"]); ?>' ref='/<?php echo ($object["shopImg"]); ?>' style='width:152px;height:152px;max-width:152px;' <?php if($object['shopImg'] =='' ): ?>style='display:none'<?php endif; ?>/>
	             </div>
             </td>
           </tr>
			<tr>
				...
				<td >
					<div>
						<img id='goodsImgPreview' src='<?php if($object['charterThums'] =='' ): ?>/<?php echo ($CONF['goodsImg']); else: ?>/<?php echo ($object['charterThums']); endif; ?>' height='152'/><br/>
					</div>
					<input type='hidden' id='charterImg' class='wstipt' value='<?php echo ($object["charterThums"]); ?>'/>
					<input type='hidden' id='charterThums' class='wstipt' value='<?php echo ($object["charterThums"]); ?>'/>
