       ...
       <form name="myform" method="post" id="myform">
        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           ...
           <tr>
             ...
             <td>订单总金额：<font color='red'>￥<?php echo ($object['needPay']); ?></font>&nbsp;(商品总金额：￥<?php echo ($object['totalMoney']); ?> + 运费：￥<?php echo ($object['deliverMoney']); ?> - 优惠券抵用：￥<?php echo ($object['couponMoney']); ?>)  </td>
           </tr>
           <tr>
