       ...
       <div class="wst-body"> 
        <table class="table table-hover table-striped table-bordered wst-list">
           <?php if(is_array($Page['root'])): $key = 0; $__LIST__ = $Page['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><thead>
             <tr>
               <th colspan='6'><?php echo ($key); ?>.订单：<?php echo ($vo['orderNo']); ?><span style='margin-left:100px;'>商铺：<a href="javascript:void(0);"><?php echo ($vo['shopName']); ?></a></span></th>
                 <!--<?php echo U('Admin/Orders/index',array('shopName'=>$vo['shopName']));?>-->
             </tr>
           </thead>
           <tbody>
             <tr>
               ...
               <td>收件人：<?php echo ($vo['userName']); ?></td>
               <td width='120'>
