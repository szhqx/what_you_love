...
<div id="wst-shortcut">
	<div class="w">
       ...
       <div class="wst-body"> 
       <div class='wst-page-header'>卖家中心 > <?php if($object['catId'] ==0 ): ?>新增<?php else: ?>编辑<?php endif; ?>商品类型</div>
       <div class='wst-page-content'>
       <form name="myform" method="post" id="myform" autocomplete="off">
        <input type='hidden' id='id' value='<?php echo ($object["catId"]); ?>'/>
        <table class="table table-hover table-striped table-bordered wst-form">
           <tr>
             <th width='120' align='right'>规格分类名称<font color='red'>*</font>：</th>
             <td><input type='text' id='catName' class="form-control wst-ipt" value='<?php echo ($object["catName"]); ?>' maxLength='25' size='40'/></td>
           </tr>
           <tr>
             <td colspan='2' style='padding-left:100px;'>
                 <button class='wst-btn-query' type="button" onclick='javascript:editAttrCats(0,"<?php echo ($umark); ?>")'>保&nbsp;存</button>
                 <?php if($object['catId'] == 0 ): ?><button class='wst-btn-query' style='width:120px;' onclick='javascript:editAttrCats(1,"<?php echo ($umark); ?>")' type="button">保存并继续新增</button><?php endif; ?>
                 <button class='wst-btn-query' type="button" onclick='javascript:location.href="<?php echo U('Home/AttributeCats/index');?>"'>返&nbsp;回</button>
             </td>
           </tr>
        </table>
       </form>
