           ...
           <tbody>
            <?php if(is_array($Page['root'])): $k = 0; $__LIST__ = $Page['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
               ...
               <div style='width:300px;'>
	               ...
	               <a target='_blank' href="<?php echo U('Wx/Goods/getGoodsDetails/',array('goodsId'=>$vo['goodsId']));?>">
							<img src="/<?php echo ($vo['goodsThums']); ?>" height="50" width="50"/>
				   </a>
				   </div>
				   <div style='width:245px;float:left'><?php echo ($vo['goodsName']); ?></div>
               </div>
               </td>
               <td>
               	<div>商品评分：
               	<?php $__FOR_START_391335058__=0;$__FOR_END_391335058__=$vo['goodsScore'];for($i=$__FOR_START_391335058__;$i < $__FOR_END_391335058__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['goodsScore']); ?> 分
				</div>
				</td>
				<td>
				<div>时效评分：
               	<?php $__FOR_START_6050480__=0;$__FOR_END_6050480__=$vo['timeScore'];for($i=$__FOR_START_6050480__;$i < $__FOR_END_6050480__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['goodsScore']); ?> 分
				</div>
                </td>
                <td>
              	<div>服务评分：
               	<?php $__FOR_START_1459072648__=0;$__FOR_END_1459072648__=$vo['serviceScore'];for($i=$__FOR_START_1459072648__;$i < $__FOR_END_1459072648__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['goodsScore']); ?> 分
				</div>
               </td>
             </tr>
             <tr>
