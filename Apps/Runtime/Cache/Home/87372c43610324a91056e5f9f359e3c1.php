...
<div id="mainsearchbox" style="text-align:center;">
	<div id="wst-search-pbox">
		...
		<div id="wst-search-container" hidden>
		...
		<div id="wst-search-des-container" hidden>
			<div class="des-box">
				<div class='wst-reach'>
...
<div class="headNav" >
		  <div class="navCon w1020" hidden>
		    ...
		    <div class="navCon-cate fl navCon_on" hidden>
		    ...
		    <div class="navCon-menu fl" hidden>
		      <ul class="fl">
	        ...
	        <form name="myform" method="post" id="myform" autocomplete="off">
	            <div class="form">
	                ...
	                <div id="o-password">
						...
						<div class="item" style='height:auto;position:relative;'>
							...
							<div class="fl item-ifo">
								...
								<div style='clear:both;'>
									...
									<input id="shopImg" name="shopImg" class="text wstipt" tabindex="3" autocomplete="off" style="" type="hidden"/>
								</div>
							</div>
						</div>
						<div class="item" style='height:auto;position:relative;'>
							<span class="label">店铺营业执照：</span>
							<div>
								<img id='goodsImgPreview' src="/<?php echo ($CONF['goodsImg']); ?>" height='152'/><br/>

								<input type='hidden' id='charterImg' class='wstipt'/>
								<input type='hidden' id='charterThums' class='wstipt'/>
								<div id="goodImgPicker" style='margin-left:0px;margin-top:5px;height:30px; padding-left: 200px;'>上传营业执照</div>
								<div style="padding-left: 200px;">图片大小:150 x 150 (px)，格式为 gif, jpg, jpeg, png</div>
							</div>
						</div>
	                    ...
	                    <!--<div class="item" style='height:auto;display: none;'>-->
	                   ...
	                   <div id='invoiceRemarkstr' class="item" style='display:none'>
	                    ...
	                    <div class="item">
	                        <span class="label"><b class="ftx04">*</b>银行卡所有人名称：</span>	
	                        <div class="fl item-ifo">
	                           <input type="text" class='text wstipt' id="bankUserName" maxlength="25" size="50">
	                        </div>
	                    </div>
	                    <div class="item">
...
<div class="wst-footer-hp-box">
    ...
    <script src="/Apps/Home/View/default/js/open_shop.js"></script>
    ...
    <script type="text/javascript">
       $(function(){
    	   ...
    	   $('#areaId1').change(function(){
    		   getAreas("areaId2",this.value,"","areaId2,areaId3");
    	   });
    	   $('#areaId2').change(function(){
	    		getCommunityForOpen();
	    		getAreas("areaId3",$(this).val(),"","areaId3");
    	   });
