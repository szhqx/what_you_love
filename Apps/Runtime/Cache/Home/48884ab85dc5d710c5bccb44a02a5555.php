...
<div id="wst-shortcut">
    ...
    <div class="wst-body"> 
       <div class='wst-page-header'>卖家中心 > 商品规格分类</div>
       <div class='wst-page-content'>
        <div class='wst-tbar-group' style='text-align:right'>
        	<span></span>
           <a href='<?php echo U("Home/AttributeCats/toEdit");?>'><span class='add btn'></span>新增分类</a>&nbsp;
        </div>
        <table class='wst-list'>
           ...
           <tbody>
            <?php if(is_array($List)): $i = 0; $__LIST__ = $List;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               ...
               <td>
               <a href="<?php echo U('Home/Attributes/index',array('catId'=>$vo['catId']));?>" class='btn view' title='属性列表'>添加</a>
               <a href="<?php echo U('Home/AttributeCats/toEdit',array('id'=>$vo['catId']));?>" class='btn edit' title='编辑'>编辑</a>
               <a href="javascript:delAttrCat(<?php echo ($vo['catId']); ?>)" class='btn del' title='删除'></a>
               &nbsp;
               </td>
        ...
        <div class='wst-tbar-group' style='text-align:right'>
        	<span></span>
           <a href='<?php echo U("Home/AttributeCats/toEdit",array("umark"=>"AttributeCats"));?>'><span class='add btn'></span>新增分类</a>&nbsp;
        </div>
        </div>
    </div>
