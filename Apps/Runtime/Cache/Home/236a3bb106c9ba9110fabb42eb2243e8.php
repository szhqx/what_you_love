    ...
    <div class="wst-body"> 
      ...
      <button class='wst-btn-query' onclick='javascript:queryUnSaleByPage()'>查询</button>
        ...
        <div class='wst-tbar-group'>
           ...
           <a href='<?php echo U("Home/Goods/toEdit",array("umark"=>"queryUnSaleByPage"));?>'><span class='add btn'></span>新增</a>
        </div>
        <table class='wst-list'>
           ...
           <tbody>
            <?php if(is_array($Page['root'])): $i = 0; $__LIST__ = $Page['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               ...
               <a href='<?php echo U("Home/Goods/toEdit",array("umark"=>"queryUnSaleByPage","id"=>$vo['goodsId']));?>' class='btn edit'></a>
