    ...
    <div class="wst-body"> 
       ...
       <div class='wst-page-content'>
        <div class='wst-tbar-query'>
           <input class='wst-btn-query' type='button' value='新增' onclick='javascript:toEditAddress(0)'>
        </div>
        <table class='wst-list'>
           <tbody>
            <?php if(is_array($List)): $i = 0; $__LIST__ = $List;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               <td><?php echo ($i); ?></td>
               <td>
               <?php if($vo['isDefault'] == 1): ?>(默认)<?php endif; echo ($vo['areaName1']); echo ($vo['areaName2']); echo ($vo['areaName3']); echo ($vo['communityName']); echo ($vo['address']); ?>
               </td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               ...
               <a href="javascript:toEditAddress(<?php echo ($vo['addressId']); ?>)" class='btn edit'>修改</a>
               <a href="javascript:delAddress(<?php echo ($vo['addressId']); ?>)" class='btn del'>删除</a>
               &nbsp;
               </td>
