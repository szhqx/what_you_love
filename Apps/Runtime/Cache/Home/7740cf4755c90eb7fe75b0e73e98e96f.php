...
<div id="wst-shortcut">
    ...
    <div class="wst-body"> 
       ...
       <div class='wst-page-content'>
       	<div style="padding:6px;">
       		...
       		<button class="wst-btn-query" onclick="javascript:getOrdersList(1)">查询</button>
       	</div>
            ...
            <?php if(is_array($payOrders['root'])): $key1 = 0; $__LIST__ = $payOrders['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($key1 % 2 );++$key1;?><tr>
				...
				<td width='100' style="padding-top:10px;vertical-align:top;"><a href="<?php echo U('Home/Shops/toShopHome/',array('shopId'=>$order['shopId']));?>" target="_blank"><?php echo ($order["shopName"]); ?></a></td>
               	...
               	<td width='130' style="line-height:20px;">
					...
					<a href="javascript:;" onclick="orderCancel(<?php echo ($order['orderId']); ?>,-2)">取消订单</a>
				</td>
             </tr><?php endforeach; endif; else: echo "" ;endif; ?>
             <?php if($payOrders['totalPage'] > 1): ?><tfoot>
             <tr>
    ...
    </div><?php echo ($receiveOrders['totalPage']); ?>
    <script>
    <?php if($payOrders['totalPage'] > 1): ?>$(document).ready(function(){
		laypage({
		    cont: 'wst-page-items',
		    pages: <?php echo ($payOrders['totalPage']); ?>, //总页数
		    skip: true, //是否开启跳页
		    skin: '#e23e3d',
		    groups: 3, //连续显示分页数
