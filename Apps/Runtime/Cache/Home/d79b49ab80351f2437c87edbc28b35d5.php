			...
			<tbody>
				<tr>
					...
					<td style="vertical-align:top;line-height:25px;">
						...
						<div style="">店铺名称：<a target="_blank" href="javascript:void(0)"><span style="color:#55AAFF"><?php echo ($shopInfo['shop']['shopName']); ?></a></span></div>
						<!--<?php echo U('Home/Shops/toShopHome/',array('shopId'=>$shopInfo['shop']['shopId']));?>-->
						<div style="">店铺状态：
					...
					<td width="280" style="vertical-align:top;line-height:25px;">
						...
						<div style="">商品描述:
							<?php $__FOR_START_1238219888__=0;$__FOR_END_1238219888__=$shopInfo['details']['goodsScore'];for($i=$__FOR_START_1238219888__;$i < $__FOR_END_1238219888__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>
							<?php echo ($shopInfo['details']['goodsScore']); ?>分
						</div>
						<div style="">时效评分:
							<?php $__FOR_START_563547172__=0;$__FOR_END_563547172__=$shopInfo['details']['timeScore'];for($i=$__FOR_START_563547172__;$i < $__FOR_END_563547172__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>
							<?php echo ($shopInfo['details']['timeScore']); ?>分
						</div>
						<div style="">服务评分:
							<?php $__FOR_START_2027953494__=0;$__FOR_END_2027953494__=$shopInfo['details']['serviceScore'];for($i=$__FOR_START_2027953494__;$i < $__FOR_END_2027953494__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>
