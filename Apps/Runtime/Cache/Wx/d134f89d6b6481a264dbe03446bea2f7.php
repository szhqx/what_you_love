...
<div class="pager">
    <div class="bxcont">
        <div class="purse">
        <div class="purse_tit"><span>余额</span><b><?php echo ((isset($userBalance) && ($userBalance !== ""))?($userBalance):'0.00'); ?></b></div>
            </div>
        <?php if(!empty($DetailsList)): ?><div class="msglist">
                    <?php if(is_array($DetailsList)): $i = 0; $__LIST__ = $DetailsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="msgitem">
                            <div class="mtit">您<span>[<?php echo ($vo["type"]); ?>]</span><?php echo ($vo["amount"]); ?>金额,账号余额剩余<?php echo ($vo["balance"]); ?></div>
                            <!--<span hidden>【未读】</span>-->
