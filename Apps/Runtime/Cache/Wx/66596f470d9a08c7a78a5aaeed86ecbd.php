...
<div class="pager">
    <div class="bxcont">
        <div class="purse">
            <div class="purse_tit"><span>积分</span><b><?php echo ((isset($userScore) && ($userScore !== ""))?($userScore):'0'); ?></b></div>
        </div>
        <?php if(!empty($scoreList)): ?><div class="msglist">
                    <?php if(is_array($scoreList["root"])): $i = 0; $__LIST__ = $scoreList["root"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="msgitem">
                            <div class="mtit">您通过订单<span>[<?php echo ($vo["orderNo"]); ?>]</span><?php if($vo["dataSrc"] == '1'): ?>交易<?php endif; if($vo["dataSrc"] == '2'): ?>评价<?php endif; if($vo["dataSrc"] == '3'): ?>的取消<?php endif; if($vo["dataSrc"] == '4'): ?>拒收反还<?php endif; ?>获得<?php echo ($vo["score"]); ?>积分</div>
                            <!--<span hidden>【未读】</span>-->
