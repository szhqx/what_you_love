...
<div class="pager">
    <div class="bxcont">
        ...
        <div class="purse_tit"><span>人数</span><b><?php echo ((isset($counts) && ($counts !== ""))?($counts):'0'); ?></b></div>
            ...
            <div class="msglist">
                    <div class="msgitem">
                        <div class="mtit">简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明
                            简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明
                            简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明
                            简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明
                            简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明放置位置简单说明
                            放置位置简单说明放置位置简单说明放置位置简单说明放置位置<span></span></div>
                        <!--<span hidden>【未读】</span>-->
                        <div class="mtime">2016-05-01</div>
                    </div>
            </div>
        <!--消息记录为空时显示-->
