...
<div class="pager">
    <div class="bxcont">
        <div class="purse">
        <div class="purse_tit"><span>人数</span><b><?php echo ((isset($counts) && ($counts !== ""))?($counts):'0'); ?></b></div>
            </div>
        <?php if(!empty($referrer)): ?><div class="msglist">
                    <?php if(is_array($referrer)): $i = 0; $__LIST__ = $referrer;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="msgitem">
                            <div class="mtit">会员<span>[<?php if($vo["nickName"] ==''): echo ($vo["userName"]); else: echo ($vo["nickName"]); endif; ?>]</span>成为您的组员</div>
                            <!--<span hidden>【未读】</span>-->
                            <div class="mtime"><?php echo ($vo["createTime"]); ?></div>
                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
         <?php else: ?>
                 <div class="pempty" style="display:block;"><img src="/static/wx/bx/images/cartoon.png"/><br/>暂无推荐的人</div><?php endif; ?>
        <!--消息记录为空时显示-->
