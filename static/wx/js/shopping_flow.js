...
function checkConsignee(frm)
{
  ...
  if (Utils.isEmpty(frm.elements['realname'].value))
  {
    err = true;
  ...
  if (Utils.isEmpty(frm.elements['telephone'].value)) {
    ...
    if (!Utils.isTel(frm.elements['telephone'].value))
    {
      err = true;
  ...
  if (frm.elements['phone'] && frm.elements['phone'].value.length > 0 && (!Utils.isMobile(frm.elements['phone'].value)))
  {
    err = true;
